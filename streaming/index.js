        ...
        if (!payload.filtered) {
          ...
          queries.push(
            client.query(
              ...
              [req.accountId, payload.account.id],
            ),
          );
        }
