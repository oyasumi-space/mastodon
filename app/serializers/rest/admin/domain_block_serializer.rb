...
class REST::Admin::DomainBlockSerializer < ActiveModel::Serializer
  attributes :id, :domain, :digest, :created_at, :severity,
             ...
             :reject_hashtag, :reject_straight_follow, :reject_new_follow, :reject_friend, :reject_relay,
             :detect_invalid_subscription, :private_comment, :public_comment, :obfuscate
